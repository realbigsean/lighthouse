...
impl<T: BeaconChainTypes> BeaconChain<T> {
    ...
    #[cfg(feature = "detailed-memory")]
    pub fn get_snapshot_cache(&self) -> usize {
        let mut ops = new_malloc_size_ops();
    ...
    // pub fn get_fork_choice(&self) -> usize where T: mem_util::MallocSizeOf, <T as BeaconChainTypes>::EthSpec: mem_util::MallocSizeOf, <T as BeaconChainTypes>::ColdStore: mem_util::MallocSizeOf, <T as BeaconChainTypes>::HotStore: mem_util::MallocSizeOf  {
    //     let mut ops = new_malloc_size_ops();
    //     MallocSizeOf::size_of(&self.fork_choice, &mut ops)
    // }

    #[cfg(feature = "detailed-memory")]
    pub fn get_hot_cold(&self) -> usize {
        let mut ops = new_malloc_size_ops();
